...
exports.defineCustomElements = function(_, opts) {
  return new Promise(function(resolve, reject) {
    if (typeof document !== 'undefined') {
      ...
      mod['data-opts'] = opts;
      mod.src = 'https://cdn.jsdelivr.net/npm/@ionic/core@5.3.0-dev.202006111355.b37c158/dist/ionic/ionic.esm.js';

      var legacy = document.createElement('script');
      legacy.setAttribute('nomodule', '');
      legacy['data-opts'] = opts;
      legacy.src = 'https://cdn.jsdelivr.net/npm/@ionic/core@5.3.0-dev.202006111355.b37c158/dist/ionic/ionic.js';
